...
**Note**: It takes about ~50 generations for the A.I. to reach the first checkpoint (when the evolution speed is set to 6), ~120 generations for the A.I. to reach the second, and so forth. The learning takes time but it eventually does win, never missing a checkpoint or dying in the face of enemies. Your own evolution took about 8 million years, so have patience with Darwin A.I.

<p align="center">
  <img src="./public/image1.png" width="800"/>
</p>
</p>
</p>
...
#### Read the full story behind DarwinAI here:
